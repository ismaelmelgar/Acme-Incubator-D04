...
<acme:form readonly="true">
	...
	<acme:form-moment code="authenticated.accounting-record.form.label.body" path="body"/>
	...
	<acme:form-checkbox code="authenticated.accounting-record.form.label.status" path="status"/>
